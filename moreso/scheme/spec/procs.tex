...
list, vector, or string.  The \ide{length} and \ide{vector-length} procedures
must return an exact
...
$$0 \leq \var{start} \leq \var{end} \leq \hbox{\tt(vector-length \var{vector})\rm.}$$}
