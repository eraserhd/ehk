...
(def __
  (fn [input]
    (let [width (->> input
          ...
          stripes [2r0000000000000000111111110000000000000000000000000000000000000000
                            ...
                            (loop [m mask
                              ...
                              (if (zero? m)
                                ...
                                (let [lsb (Long/lowestOneBit m)
                                  ...
                                  (recur
                                    m-without-lsb
                                    (bit-xor (bit-shift-left vs 2) (Long/numberOfTrailingZeros (aget ^longs a-input index))))))))
